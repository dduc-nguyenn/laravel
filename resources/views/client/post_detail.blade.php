            ...
            <div class=" col-lg-9 mb-5 mb-lg-0">
                <article>
                    <div class="post-slider mb-4">
                        <img src="{{ $post->thumbnail }}" class="card-img" alt="post-thumb">
                    </div>
                    ...
                    <ul class="card-meta my-3 list-inline">
                        ...
                        <li class="list-inline-item">
                            <i class="ti-calendar"></i>{{ $post->format_created_at }}
                        </li>
                        <li class="list-inline-item">
                            <ul class="card-meta-tag list-inline">
                                <li class="list-inline-item"><a href="{{ route('category', $post->category_id) }}">{{ $post->category->name }}</a></li>
                ...
                <div class="mb-5 border-top mt-4 pt-5">
                    ...
                    <div class="media d-block d-sm-flex mb-4 pb-4">
                        <a class="d-inline-block mr-2 mb-3 mb-md-0" href="#">
                            <img src="/theme/client/images/post/user-01.jpg" class="mr-3 rounded-circle" alt="">
                        </a>
                    ...
                    <div class="media d-block d-sm-flex">
                        <div class="d-inline-block mr-2 mb-3 mb-md-0" href="#">
                            <img class="mr-3" src="/theme/client/images/post/arrow.png" alt="">
                            <a href="#!"><img src="/theme/client/images/post/user-02.jpg" class="mr-3 rounded-circle" alt=""></a>
                        </div>
                        <div class="media-body">
